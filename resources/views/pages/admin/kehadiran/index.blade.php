                                                ...
                                                <table class="table table-sm table-borderless ">
                                                    <tr>
                                                        ...
                                                        <td class="text-right font-weight-bold">
                                                            {{ $days->ekstrakulikuler->nama_ekstrakulikuler }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Kelas</td>
                                                        <td class="text-right font-weight-bold">
                                                            {{ $days->kelas->nama_kelas }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Waktu</td>
                                                        <td class="text-right font-weight-bold">{{ $days->dari_jam }} s/d
                                                            {{ $days->sampai_jam }}</td>
                                                    </tr>
                                                </table>
                                                <a href="absensi/absen/{{ $days->id }}"
                                                    class="btn btn-sm btn-primary w-100 mt-1">Mulai Absensi</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
