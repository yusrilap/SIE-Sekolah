            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless ">
                        <tr>
                            <td>Kelas</td>
                            <td class="text-left font-weight-bold">{{$jadwal->kelas_id}}</td>
                            <td>Hari</td>
                            <td class="text-left font-weight-bold">{{$jadwal->hari}}</td>
                        </tr>
                        <tr>
                            <td>Ekstrakulikuler</td>
                            <td class="text-left font-weight-bold">{{$jadwal->ekstrakulikuler_id}}</td>
                            <td>Waktu</td>
                            <td class="text-left font-weight-bold">{{$jadwal->dari_jam}} s/d {{$jadwal->sampai_jam}}</td>
                        </tr>
                    </table>
                </div>
                <hr>
                                ...
                                @foreach($siswa as $siswas)
                                    <tr>
                                        ...
                                        <td class="text-center col-md-2">
                                            <input type="text" class="form-control text-center" name="input[{{$no1++}}][nis]" value="{{$siswas->nis}}" style="border: none; outline: none;" readonly/>
                                        </td>
                                        <td class="text-center col-md-2">
                                            <input type="text"class="form-control text-center" name="input[{{$no2++}}][telp]" value="{{$siswas->telp}}" style="border: none; outline: none;" readonly/>
                                        </td>
                                        <td class="text-center col-md-4">
                                            <input type="text"class="form-control" name="input[{{$no3++}}][nama]" value="{{$siswas->nama}}" style="border: none; outline: none;" readonly/>
                                        </td>
                                        <td class="text-center col-md-4">
