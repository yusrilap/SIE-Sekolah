                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>List Ekstrakulikuler</h4>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i
                                    class="nav-icon fas fa-folder-plus"></i>&nbsp; Tambah Data Ekstrakulikuler</button>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($ekstrakulikuler as $result => $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('ekstrakulikuler.destroy', $data->id) }}">
                                                            @csrf
                                                            @method('delete')
