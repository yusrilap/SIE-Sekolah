                            ...
                            <form method="POST" action="{{ route('materi.update', $materi->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="judul" name="judul"
                                        ...
                                        placeholder="{{ __('Judul materi') }}" value="{{ $materi->judul ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi</label>
                                    <textarea id="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                        placeholder="{{ __('Deskripsi materi') }}">{{ $materi->deskripsi ?? '' }}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="kelas_id" name="kelas_id"
                                        ...
                                        @foreach ($kelas as $data)
                                            <option value="{{ $data->id }}"
                                                @if ($materi->kelas_id == $data->id) selected @endif>
